  ...
  const article = [
    {
      articleTitle: "宗旨",
      articleContent:
        "「赤弦獎--紅樓琴緣民歌比賽」是采音吉他社最為重要且盛大的活動，自民國 90 年開始舉辦，至今即將進入第二十五屆。初期是以舉辦給北科學生參賽為主，經由多屆的比賽累積活動經驗及檢討，嘗試於第七屆擴大賽事，廣集新竹以北之各大專院校之參賽者共襄盛舉，於第八屆將賽事擴大至全國大專院校及北部高中職，第十三屆增加演奏組，第十四屆更是新增音樂節活動，邀請十三屆得獎人為我們表演，並於第十八屆將賽事更擴大至全國大專院校及全國高中職。希望透過赤弦獎這個比賽，讓參賽者能夠不僅保有赤子之心，還能實踐對音樂的熱愛，在求學生涯中能有機會展現自我，並於賽事中發掘人才，提升國內的音樂素質。",
      articleImage: " ",
      articleLink: " ",
    },
    {
